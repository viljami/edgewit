...
*If configured, Github Actions automatically pushes these documents to Github Pages on every commit.*
...
*(See `PROJECT.md` for a full breakdown of the project vision).*
