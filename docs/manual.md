...
- **[Index Schema & Definition]({{ '/index_schema/' | relative_url }})**: Learn how to explicitly define indexes and data types using YAML for deterministic recovery.
...
```bash
docker run -p 9200:9200 -v edgewit_data:/data ghcr.io/viljami/edgewit:latest
```
